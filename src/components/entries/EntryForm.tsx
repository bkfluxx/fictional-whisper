        ...
        <div className="flex flex-col gap-1 md:flex-row md:items-start md:gap-4">
          ...
          <div className="flex items-center gap-2 md:shrink-0">
            ...
            {entryId && (
              <Badge
                variant="meta"
                render={<button onClick={() => setDeleteConfirm(true)} aria-label="Delete entry" />}
                className="cursor-pointer hover:bg-red-500/10 hover:border-red-500/20 hover:text-red-400 transition-colors"
              >
